...
SEARCH_PRODUCT_INFO_TOOL_DESCRIPTION = "製品・商品の詳細情報や仕様を参照したい時に使う"
...
SYSTEM_PROMPT_NOTICE_SLACK = """
    ...
    # 命令
    Slackの「動画検証」チャンネルで、メンバーIDが{slack_id_text}のメンバーに一度だけメンションを当て、生成したメッセージを送信してください。
    ...
    - 【メンション先の選定理由】について、以下の条件に従って生成してください。
        - メンション先として選ばれた従業員それぞれについて、なぜその人が選ばれたのか、具体的な理由を生成してください。
        - 従業員の所属部署、役職、過去の対応履歴、専門知識などを基に理由を記述してください。
